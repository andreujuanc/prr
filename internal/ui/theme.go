...
func themeDracula() Theme {
	return Theme{
		...
		TextMuted:         lipgloss.Color("#828FB7"),
...
func themeTokyoNight() Theme {
	return Theme{
		...
		TextMuted:         lipgloss.Color("#737AA2"),
		TextSubtle:        lipgloss.Color("#414868"),
...
func themeNord() Theme {
	return Theme{
		...
		TextSubtle:        lipgloss.Color("#4C566A"),
...
func themeSolarizedDark() Theme {
	return Theme{
		...
		TextSubtle:        lipgloss.Color("#657B83"),
...
func themeOneDark() Theme {
	return Theme{
		...
		TextMuted:         lipgloss.Color("#7F848E"),
		TextSubtle:        lipgloss.Color("#5C6370"),
...
func themeRosePine() Theme {
	return Theme{
		...
		TextMuted:         lipgloss.Color("#86829C"),
		TextSubtle:        lipgloss.Color("#6E6A86"),
